...
import { addUser, registeredUsersSlice } from '../../slices/registeredUsersSlice';
...
export const UncontrolledForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const { confirmPassword, terms, ...user } = result.data;
    delete result.data.confirmPassword;
    delete result.data.terms;
    dispatch(addUser(user<RegisteredUser>));
    setErrors({});
  };
