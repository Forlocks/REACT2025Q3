  ...
  return (
    <form className="form" onSubmit={handleSubmit}>
      <div className="form__field">
        ...
        {errors.photo && <div className="">{errors.photo}</div>}
      </div>
      <div className="form__field">
      ...
      <div className="form__field">
        ...
        {errors.country && <div className="">{errors.country}</div>}
      </div>
      <div className="form__field">
        <label htmlFor="age">Age</label>
        <input id="age" name="age" type="number" style={{ width: "70px" }} />
        {errors.age && <div className="">{errors.age}</div>}
      </div>
      <div className="form__field">
      ...
      <div className="form__field">
        ...
        {errors.confirmPassword && <div className="">{errors.confirmPassword}</div>}
      </div>
      <div className="form__field">
        <label htmlFor="terms">I agree to the terms</label>
        <input id="terms" name="terms" type="checkbox" style={{ width: "20px" }} />
        {errors.terms && <div className="">{errors.terms}</div>}
      </div>
