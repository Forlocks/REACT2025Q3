...
export const UncontrolledForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      gender: formData.get('gender') as "Male" | "Female" | "Military helicopter",
    ...
    const file = result.data.photo[0] as File | undefined;

    const base64 = reader.result as string;

    // создаём объект RegisteredUser вручную, без деструктуризации
