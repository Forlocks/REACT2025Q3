...
export const UncontrolledForm: React.FC<UncontrolledFormProps> = ({ onClose }) => {
  ...
  return (
    <form className="form" onSubmit={handleSubmit} autoComplete="on">
      ...
      <div className="form__field">
        ...
        <input id="country" name="country" list="country-options" placeholder="Country" />
        <datalist id="country-options">
          {countries.map((c: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined, i: React.Key | null | undefined) => (
      ...
      <div className="form__field">
        ...
        <input id="age" name="age" type="number" style={{ width: "70px" }} placeholder="Age" />
...
function selectCountries(state: unknown): unknown {
