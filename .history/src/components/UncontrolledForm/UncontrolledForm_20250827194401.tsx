  ...
  return (
    <form className="form" onSubmit={handleSubmit}>
      ...
      <div className="form__field">
        ...
        <input id="gender1" name="gender1" type="radio" style={{ width: "15px" }} />
        <label htmlFor="gender2">Female</label>
        <input id="gender2" name="gender2" type="radio" style={{ width: "15px" }} />
        <label htmlFor="gender">Military helicopter</label>
        <input id="gender3" name="gender3" type="radio" style={{ width: "15px" }} />
      </div>
