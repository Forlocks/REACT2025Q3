...
import { selectAllCountries } from '../../slices/countriesSlice';
...
export const UncontrolledForm: React.FC<UncontrolledFormProps> = ({ onClose }) => {
  ...
  const countries: string[] = useSelector(selectAllCountries);
  ...
  return (
    <form className="form" onSubmit={handleSubmit} autoComplete="on" role="form">
