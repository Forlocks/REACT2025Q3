  ...
  return (
    <form className="form" onSubmit={handleSubmit(onSubmit)} autoComplete="on">
      ...
      <div className="form__field">
        ...
        <input id="country" list="country-options" {...register('country')} placeholder="Country" />
      ...
      <div className="form__field">
        ...
        <input id="mail" {...register('email')} placeholder="Email" />
      ...
      <div className="form__field">
        ...
        <input id="confirm-password" type="password" {...register('confirmPassword')} placeholder="Confirm password" />
