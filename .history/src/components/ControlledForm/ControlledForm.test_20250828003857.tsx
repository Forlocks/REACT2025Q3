...
beforeEach(() => {
  // Мокаем useSelector для countries, чтобы тесты не падали
  const useSelectorMock = vi.spyOn(redux, 'useSelector').mockImplementation(() => {
    return ['USA', 'UK', 'Germany']; // просто возвращаем фиктивный массив стран
  });
