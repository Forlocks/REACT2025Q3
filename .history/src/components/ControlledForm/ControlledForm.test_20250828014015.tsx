...
describe('ControlledForm - individual fields', () => {
  ...
  it('selects Gender radio button', () => {
    renderForm();
    const maleRadio = screen.getByLabelText(/Ьale/i) as HTMLInputElement;
    const femaleRadio = screen.getByLabelText(/female/i) as HTMLInputElement;
