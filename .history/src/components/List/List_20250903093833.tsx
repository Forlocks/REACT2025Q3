...
export const List: React.FC<ListProps> = ({
  ...
  // 2️⃣ Фильтруем и сортируем при изменении фильтров
  useEffect(() => {
    if (loading) return; // данные еще не загрузились
    ...
    setEmissions(Object.fromEntries(entries));
  }, [country, year, sortAttribute, sortOrder, rawData, loading]);
