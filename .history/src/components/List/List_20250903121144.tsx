...
export const List: React.FC<ListProps> = ({
  ...
  const emmissions = use(emissionPromise);

  useEffect(() => {
    const entries = Object.entries(emmissions)
    ...
    setProcessedEmissions(Object.fromEntries(entries) as Countries);
  }, [country, year, sortAttribute, sortOrder, emmissions]);
