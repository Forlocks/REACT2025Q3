...
export const MainPage: React.FC = () => {
  ...
  const handleCheckboxClick = (event: React.Mo) => {
    ...
    <div className={isModalOpen ? "main main--blurred" : "main"} onClick={() => isModalOpen && setIsModalOpen(false)}>
      ...
      <ModalColumns isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="modal__content">
          <Checkbox onCheckboxChange={handleCheckboxClick}>Cement co2</Checkbox>
          <Checkbox onCheckboxChange={handleCheckboxClick}>Cement co2 per capita</Checkbox>
          <Checkbox onCheckboxChange={handleCheckboxClick}>Cumulative cement co2</Checkbox>
          <Checkbox onCheckboxChange={handleCheckboxClick}>Methane</Checkbox>
          <Checkbox onCheckboxChange={handleCheckboxClick}>Methane per capita</Checkbox>
          <Checkbox onCheckboxChange={handleCheckboxClick}>Nitrous oxide per capita</Checkbox>
          <Checkbox onCheckboxChange={handleCheckboxClick}>Nitrous oxide</Checkbox>
        </div>
      </ModalColumns>
    </div>
  );
