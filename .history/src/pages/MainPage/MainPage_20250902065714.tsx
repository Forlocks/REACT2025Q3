    ...
    <div className={isModalOpen ? "main main--blurred" : "main"} onClick={() => isModalOpen && setIsModalOpen(false)}>
      ...
      <ModalColumns isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="modal__content">
          ...
          <Checkbox onck={handleCheckboxClick}>Cement co2 per capita</Checkbox>
          <Checkbox onck={handleCheckboxClick}>Cumulative cement co2</Checkbox>
          <Checkbox onck={handleCheckboxClick}>Methane</Checkbox>
          <Checkbox onck={handleCheckboxClick}>Methane per capita</Checkbox>
          <Checkbox onck={handleCheckboxClick}>Nitrous oxide per capita</Checkbox>
          <Checkbox onck={handleCheckboxClick}>Nitrous oxide</Checkbox>
        </div>
      </ModalColumns>
    </div>
  );
