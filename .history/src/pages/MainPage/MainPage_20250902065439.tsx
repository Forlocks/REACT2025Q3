    ...
    <div className={isModalOpen ? "main main--blurred" : "main"} onClick={() => isModalOpen && setIsModalOpen(false)}>
      ...
      <ModalColumns isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="modal__content">
          <Checkbox onChange={handleCheckboxClick}>Cement co2</Checkbox>
          <Checkbox onChange={handleCheckboxClick}>Cement co2 per capita</Checkbox>
          <Checkbox onChange={handleCheckboxClick}>Cumulative cement co2</Checkbox>
          <Checkbox onChange={handleCheckboxClick}>Methane</Checkbox>
          <Checkbox onChange={handleCheckboxClick}>Methane per capita</Checkbox>
          <Checkbox onChange={handleCheckboxClick}>Nitrous oxide per capita</Checkbox>
          <Checkbox onChange={handleCheckboxClick}>Nitrous oxide</Checkbox>
        </div>
      </ModalColumns>
    </div>
  );
