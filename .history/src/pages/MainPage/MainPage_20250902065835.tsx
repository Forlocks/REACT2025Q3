    ...
    <div className={isModalOpen ? "main main--blurred" : "main"} onClick={() => isModalOpen && setIsModalOpen(false)}>
      ...
      <ModalColumns isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="modal__content">
          ...
          <Checkbox onCheckboxClick={handleCheckboxClick}>Cement co2 per capita</Checkbox>
          <Checkbox onCheckboxClick={handleCheckboxClick}>Cumulative cement co2</Checkbox>
          <Checkbox onCheckboxClick={handleCheckboxClick}>Methane</Checkbox>
          <Checkbox onCheckboxClick={handleCheckboxClick}>Methane per capita</Checkbox>
          <Checkbox onCheckboxClick={handleCheckboxClick}>Nitrous oxide per capita</Checkbox>
          <Checkbox onCheckboxClick={handleCheckboxClick}>Nitrous oxide</Checkbox>
        </div>
      </ModalColumns>
    </div>
  );
